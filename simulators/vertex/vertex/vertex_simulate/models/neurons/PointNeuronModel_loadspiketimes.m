classdef PointNeuronModel_loadspiketimes < handle
  %PointNeuronModel_loadspiketimes Neurons with predefined spike times
  %(single compartment)
  ...
  methods
    function NM = PointNeuronModel_loadspiketimes(~, number, spikeTimeCell)
      NM.number = number;
